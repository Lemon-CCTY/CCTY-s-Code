<template>
  ...
  <div>
    ...
    <div>
      <el-input style="width: 200px;" v-model="consumerName" placeholder="请输入姓名" suffix-icon="el-icon-search">
      </el-input>
      <el-input style="width: 200px;" v-model="phone" placeholder="请输入手机号" suffix-icon="el-icon-phone">
      </el-input>
      <el-input style="width: 200px;" v-model="address" placeholder="请输入地址"
    ...
    <el-table :data="tableData" stripe border style="" @selection-change="handleSelectionChange">
      ...
      <el-table-column prop="consumerId" label="学号" width="140">
      </el-table-column>
      <el-table-column prop="consumerName" label="姓名" width="120">
      </el-table-column>
    ...
    <el-dialog title="用户信息" :visible.sync="dialogFormVisible" width="30%" size="small">
      <el-form :model="form" label-width="80px" :rules="rules" ref="consumersForm">
